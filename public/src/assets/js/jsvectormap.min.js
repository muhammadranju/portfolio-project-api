...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).jsVectorMap = e();
}(this, function () {
  "use strict";
  ...
  var o = function o(e, a, n) {
    ...
    h = function h(t) {
      return "object" == _typeof(t) && void 0 !== t.nodeType ? t : "string" == typeof t ? document.querySelector(t) : null;
    },
  ...
  function b(t, e) {
    t.prototype = Object.create(e.prototype), t.prototype.constructor = t, _(t, e);
  }
  function _(t, e) {
  ...
  var x = function () {
      ...
      return t.prototype.dispose = function () {
        ...
        for (var t, e = k(Object.getOwnPropertyNames(this)); !(t = e()).done;) {
          this[t.value] = null;
        }
      }, t;
    }(),
    M = {
      getLabelText: function getLabelText(t, e) {
        if (e) {
      ...
      getLabelOffsets: function getLabelOffsets(t, e) {
      ...
      _setStatus: function _setStatus(t, e) {
    ...
    j = function (t) {
      function e(e) {
        ...
        if (o && u) {
          ...
          i.labelX = c.x + c.width / 2 + p[0], i.labelY = c.y + c.height / 2 + p[1], i.label = i._map.canvas.createText({
            text: u,
            textAnchor: "middle",
  ...
  var C = function (t) {
    ...
    return b(e, t), e.prototype.setStyle = function (t, e) {
      this.shape.setStyle(t, e);
    }, e;
  }(x);
  var L = function (t) {
  ...
  var O = function () {
        ...
        for (var o = 0; o < a.length; o++) {
          switch (t = l("div", "jvm-legend-tick"), e = l("div", "jvm-legend-tick-sample"), this._series.config.attribute) {
            ...
            case "stroke":
              ...
              break;
            case "image":
              e.style.background = "url(" + ("object" == _typeof(a[o].value) ? a[o].value.url : a[o].value) + ") no-repeat center center", e.style.backgroundSize = "cover";
          }
    ...
    X = function () {
      function t(t, e, i) {
        void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), "object" == _typeof(t.scale) && (this.scale = new A(t.scale)), this.config.legend && (this.legend = new O(u({
          map: this._map,
          series: this
  ...
  var E = {
      _setupContainerEvents: function _setupContainerEvents() {
        var t,
          e,
          i = this,
          s = !1,
        ...
        this.params.draggable && (g.on(this.container, "mousemove", function (i) {
          if (!s) return !1;
          a.transX -= (t - i.pageX) / a.scale, a.transY -= (e - i.pageY) / a.scale, a._applyTransform(), t = i.pageX, e = i.pageY;
          ...
          a.tooltip && a.tooltip.hide(), a._setScale(a.scale * o, n, r), t.preventDefault();
        });
      },
      _setupElementEvents: function _setupElementEvents() {
        var t,
          e,
          i,
          s = this,
        ...
        g.on(a, "mousemove", function (s) {
          ...
          "mouseover" === t.type ? (e.element.hover(!0), s.tooltip.text(e.tooltipText), s._emit(e.event, [t, s.tooltip, e.code]), t.defaultPrevented || i && s.tooltip.show()) : (e.element.hover(!1), i && s.tooltip.hide());
      ...
      _setupZoomButtons: function _setupZoomButtons() {
        var t = this,
          e = this,
          i = l("div", "jvm-zoom-btn jvm-zoomin", "&#43;", !0),
          s = l("div", "jvm-zoom-btn jvm-zoomout", "&#x2212", !0);
        this.container.appendChild(i), this.container.appendChild(s), g.on(i, "click", function () {
          t._setScale(e.scale * e.params.zoomStep, e.width / 2, e.height / 2, !1, e.params.zoomAnimate);
        }), g.on(s, "click", function () {
          t._setScale(e.scale / e.params.zoomStep, e.width / 2, e.height / 2, !1, e.params.zoomAnimate);
        });
      },
      _setupContainerTouchEvents: function _setupContainerTouchEvents() {
        var t,
          e,
          i,
          s,
          ...
          h = function h(_h) {
            var l,
              ...
              p,
              d = _h.touches;
            if ("touchstart" == _h.type && (r = 0), 1 == d.length) 1 == r && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o._applyTransform(), u == o.transX && p == o.transY || _h.preventDefault()), i = d[0].pageX, s = d[0].pageY;else if (2 == d.length) if (2 == r) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o._setScale(t * c, a, n), o.tooltip.hide(), _h.preventDefault();else {
      ...
      _createRegions: function _createRegions() {
        var t, e;
        for (t in this._regionLabelsGroup = this._regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths) {
          e = new j({
            map: this,
            code: t,
      ...
      _createLines: function _createLines(t, e, i) {
        void 0 === i && (i = !1);
        var s = !1,
          a = !1;
        for (var n in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t) {
          ...
          !1 !== s && !1 !== a && (this.lines[p(r.from, r.to)] = new C({
            index: n,
            map: this,
            style: u({
      ...
      _createMarkers: function _createMarkers(t, e) {
        var i,
          s,
          a,
          n,
          r = this;
        for (var o in void 0 === t && (t = {}), void 0 === e && (e = !1), this._markersGroup = this._markersGroup || this.canvas.createGroup("jvm-markers-group"), this._markerLabelsGroup = this._markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t) {
          if (i = t[o], a = this.getMarkerPosition(i), n = i.coords.join(":"), a) {
            if (e) {
      ...
      _applyTransform: function _applyTransform() {
        var t, e, i, s;
        this.defaultWidth * this.scale <= this.width ? (t = (this.width - this.defaultWidth * this.scale) / (2 * this.scale), i = (this.width - this.defaultWidth * this.scale) / (2 * this.scale)) : (t = 0, i = (this.width - this.defaultWidth * this.scale) / this.scale), this.defaultHeight * this.scale <= this.height ? (e = (this.height - this.defaultHeight * this.scale) / (2 * this.scale), s = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)) : (e = 0, s = (this.height - this.defaultHeight * this.scale) / this.scale), this.transY > e ? this.transY = e : this.transY < s && (this.transY = s), this.transX > t ? this.transX = t : this.transX < i && (this.transX = i), this.canvas.applyTransformParams(this.scale, this.transX, this.transY), this.markers && this._repositionMarkers(), this.lines && this._repositionLines(), this._repositionLabels();
      },
      _resize: function _resize() {
        var t = this.baseScale;
        this.width / this.height > this.defaultWidth / this.defaultHeight ? (this.baseScale = this.height / this.defaultHeight, this.baseTransX = Math.abs(this.width - this.defaultWidth * this.baseScale) / (2 * this.baseScale)) : (this.baseScale = this.width / this.defaultWidth, this.baseTransY = Math.abs(this.height - this.defaultHeight * this.baseScale) / (2 * this.baseScale)), this.scale *= this.baseScale / t, this.transX *= this.baseScale / t, this.transY *= this.baseScale / t;
      },
      _setScale: function _setScale(t, e, i, s, a) {
        var n,
          r,
          o,
          h,
      ...
      setFocus: function setFocus(t) {
        ...
        }), this._setScale(Math.min(this.width / i.width, this.height / i.height), -(i.x + i.width / 2), -(i.y + i.height / 2), !0, t.animate);
        if (t.coords) {
      ...
      coordsToPoint: function coordsToPoint(t, e) {
        var i,
          ...
          r = n.centralMeridian;
        return i = Y[n.type](t, e, r), !!(s = this.getInsetForPoint(i.x, i.y)) && (a = s.bbox, i.x = (i.x - a[0].x) / (a[1].x - a[0].x) * s.width * this.scale, i.y = (i.y - a[0].y) / (a[1].y - a[0].y) * s.height * this.scale, {
      ...
      _repositionLines: function _repositionLines() {
        var t = !1,
          e = !1;
      ...
      _repositionMarkers: function _repositionMarkers() {
        var t;
      ...
      _repositionLabels: function _repositionLabels() {
    ...
    z = function (t) {
      ...
      return i.setStyle = function (t, e) {
        var i;
        "object" == _typeof(t) ? u(this.style.current, t) : u(this.style.current, ((i = {})[t] = e, i));
        this.updateStyle();
    ...
    P = function (t) {
      ...
      return b(e, t), e.prototype.applyAttr = function (e, i) {
    ...
    R = function (t) {
      function e(e) {
        ...
        return i._map = e, i._tooltip = document.body.appendChild(s), i._bindEventListeners(), w(i) || w(i);
      }
      b(e, t);
      var i = e.prototype;
    ...
    V = function () {
      ...
      return e._init = function () {
        ...
        var i = p(t, e);
        this.lines.hasOwnProperty(i) && (this.lines[i].element.remove(), delete this.lines[i]);
      }, e.reset = function () {
        for (var t in this.series) {
        ...
        var e = this;
        void 0 === t && (t = !0), g.flush(), this.tooltip.dispose(), this._emit(v.onDestroyed), t && Object.keys(this).forEach(function (t) {
          try {
            delete e[t];
          } catch (t) {}
        });
      }, e.extend = function (e, i) {
        if ("function" == typeof this[e]) throw new Error("The method [" + e + "] already exists internally please use another name.");
        t.prototype[e] = i;
      }, t;
    }();
  V.maps = {}, V.defaults = {
